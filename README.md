...
Visit the [live demo and interactive configurator](https://miguelcolmenares.github.io/whatsapp-widget/) to customize and test the widget before integrating it into your website.
...
- **`docs`** branch: Contains the demo page and widget configurator
  ...
  - Used for [GitHub Pages](https://miguelcolmenares.github.io/whatsapp-widget/)
